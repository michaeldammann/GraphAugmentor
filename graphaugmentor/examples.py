...
def example_directed():
    ...
    return augmented_batch_directed

def example_undirected():
    ...
    data_undirected_0 = Data(x=x_undirected, edge_index=edge_index_undirected, edge_attr=edge_attr_undirected)
    ...
    return augmented_batch_undirected

if __name__ == "__main__":
    print('Directed example: ', example_directed())
    print('Undirected example: ', example_undirected())